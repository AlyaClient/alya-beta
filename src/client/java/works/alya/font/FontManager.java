...
package works.alya.font;

import works.alya.Alya;
...
public class FontManager {
    ...
    public static TextRenderer getFont(final String fontName, final int size) {
        ...
        final TrueTypeFontLoader loader = new TrueTypeFontLoader(
                Identifier.of(Alya.MOD_ID, fontName + ".ttf"),
        ...
        try {
            ...
            final Identifier storageId = Identifier.of(Alya.MOD_ID, String.format("%s_font", key));

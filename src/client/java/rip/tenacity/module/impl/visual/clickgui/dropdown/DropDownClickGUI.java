...
package rip.tenacity.module.impl.visual.clickgui.dropdown;

import rip.tenacity.config.setting.impl.BooleanSetting;
import rip.tenacity.config.setting.impl.ModeSetting;
import rip.tenacity.config.setting.impl.MultipleBooleanSetting;
...
import rip.tenacity.utilities.render.*;
...
public class DropDownClickGUI extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        for(Map.Entry<ModuleCategory, List<Module>> entry : categorizedModules.entrySet()) {
            ...
            RenderUtility.drawRoundedRectOutline(context, categoryX, y, PANEL_WIDTH, totalHeight, CORNER_RADIUS, 1, Theme.COLOR$1);
            ...
            Identifier img = Identifier.of("tenacity", "icons/category/" + category.toString().toLowerCase() + ".png");
            ...
            if(expanded) {
                for(int moduleIndex = 0; moduleIndex < modules.size(); moduleIndex++) {
                    ...
                    if(hoverModule) {
                        ...
                        if(shouldRoundBottom) {
                            hoverRadius = new Vector4f(0f, 0f, CORNER_RADIUS, CORNER_RADIUS);
                        }
                    ...
                    if(isModuleExpanded) {
                        ...
                        for(int settingIndex = 0; settingIndex < visibleSettings.size(); settingIndex++) {
                            ...
                            if(isLastSetting) {
                                settingRadius = new Vector4f(0f, 0f, CORNER_RADIUS, CORNER_RADIUS);
                            }

...
package rip.tenacity.module.impl.combat.killaura;
...
public class KillauraModule extends Module {
    ...
    private final IEventListener<TickEvent> tickEvent = event -> {
        AttackDelayModule attackDelayModule = TenacityClient.INSTANCE.getModuleRepository().getModule(AttackDelayModule.class);

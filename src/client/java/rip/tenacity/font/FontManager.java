...
package rip.tenacity.font;

import rip.tenacity.Tenacity;
...
public class FontManager {
    ...
    public static TextRenderer getFont(final String fontName, final int size) {
        ...
        final TrueTypeFontLoader loader = new TrueTypeFontLoader(
                Identifier.of(Tenacity.MOD_ID, fontName + ".ttf"),
        ...
        try {
            ...
            final Identifier storageId = Identifier.of(Tenacity.MOD_ID, String.format("%s_font", key));

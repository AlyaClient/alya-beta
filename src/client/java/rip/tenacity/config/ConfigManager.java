...
import static rip.tenacity.TenacityClient.LOGGER;

@SuppressWarnings({"CallToPrintStackTrace", "unused"})
public class ConfigManager {
    private static final String CONFIG_FOLDER = MinecraftClient.getInstance().runDirectory + "/" + TenacityClient.getName() + "/configs/";
    ...
    public static void saveConfig(String name) {
        ...
        for(Module module : TenacityClient.INSTANCE.getModuleRepository().getModules()) {
            ...
            if(config != null) {
                ...
                if(keybinds != null) {
                    ...
                    for(Map.Entry<String, Double> entry : keybinds.entrySet()) {
                        Module module = TenacityClient.INSTANCE.getModuleRepository().getModuleByName(entry.getKey());
                        if(module != null) {

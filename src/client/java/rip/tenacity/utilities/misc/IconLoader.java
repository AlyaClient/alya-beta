...
public class IconLoader {
    ...
    public static void setWindowIcon(long windowHandle) {
        try(InputStream icon16 = Objects.requireNonNull(IconLoader.class.getResourceAsStream("/assets/tenacity/icons/icon_16x16.png"));
            InputStream icon32 = Objects.requireNonNull(IconLoader.class.getResourceAsStream("/assets/tenacity/icons/icon_32x32.png"))) {
